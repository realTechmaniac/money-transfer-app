			...
			<div class="offset-md-2 col-md-8 offset-md-2 border border-light p-5 bg-white">
				...
				<form method="POST" action="{{url('/save')}}">
					...
					<div class="row">
						...
						<div class="col">
							...
							<div class="form-group">
							    <label for="exampleFormControlSelect1" class="font-weight-bold"> Sender Currency</label>
						...
						<div class="col">
							...
							<div class="form-group">
							    <label for="exampleInputPassword1" class="font-weight-bold">Amount to send</label>
							    <input type="number" class="form-control" id="amount_to_send" name="amount" placeholder="Amount to Send" value="{{old('amount')}}">
							</div>
					...
					<div class="form-group">
					    ...
					    <label for="exampleFormControlSelect1" class="font-weight-bold">Recipient Currency</label>
					...
					<div class="form-group mt-4">
					    <label for="exampleInputPassword1" class="font-weight-bold">Recipient receives </label> <h5><strong<span id="total_amount_to_recieve"></span></strong>
                        </h5>
					</div>
