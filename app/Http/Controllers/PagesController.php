    ...
    if ($amount) {
        ...
        if ($currency === 'EUR') {
            ...
            if ($exchangeCurrency === 'KES') {
                ...
                $total_amount  = intval($amount) * 1.22 * 107;

            }else{


                $total_amount  = intval($amount) * 1.22 * 5.6;
            }
            ...
            if ($exchangeCurrency === 'KES') {
                 ...
                 $total_amount  = intval($amount) * 1.37 * 107;

            }else{


                $total_amount  = intval($amount)  * 1.37 *5.6;
            }
            ...
            if ($exchangeCurrency === 'KES') {
                ...
                $total_amount  = intval($amount) * 1 * 107;

            }else{

                $total_amount  = intval($amount) *1* 5.6;
            }
